...
describe('AddCommentUseCase', () => {
  ...
  it('should orchestrating the add comment action correctly', async () => {
    ...
    mockCommentRepository.addComment = jest
      .fn()
      .mockImplementation(() => Promise.resolve(mockReturnComment));
    ...
    expect(addedComment.id).toEqual(mockReturnComment.id);
    expect(addedComment.content).toEqual(mockReturnComment.content);
    expect(addedComment.owner).toEqual(mockReturnComment.owner);
  });
});
